...
fun main(args: Array<String>) {
    val help = """
        ...
        args[4] - true if it is necessary to copy all files from a folder, 
                  if at least one file from it is required (default is true).
        """.trimIndent()
    try {
        ...
        val isBoldMode = if (args.size >= 5) args[4].toBoolean() else true
